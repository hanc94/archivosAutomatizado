...
fid=fopen('TramasGOPH264.txt','r');%se abre el archivo para su lectura.
...
rtp=strfind(a,'PT');%se obtiene las posiciones donde se encuentran los caracteres "RTP".
type_f=strfind(a,'slice_type:');
aux=[];
...
file_audio=fopen('GOPH_frame.txt','w');
